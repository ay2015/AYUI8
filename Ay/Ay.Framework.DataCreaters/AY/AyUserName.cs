...
namespace Ay.Framework.DataCreaters
{
    public class AyUserName
    {
        ...
        public static string[] UserNameAndFirstName()
        {
            ...
            if (namelength == 2)
            {
                var _1 = FirstName[rnd.Next(0, FirstName.Length)];
                name = _1 + LastName[rnd.Next(0, LastName.Length)];
                returnResult[0] = name;
                returnResult[1] = _1;
            }
            else if (namelength == 3)
            {
                var _1 = FirstName[rnd.Next(0, FirstName.Length)];
                name = _1 + LastName[rnd.Next(0, LastName.Length)] + LastName[rnd.Next(0, LastName.Length)];
                returnResult[0] = name;
                returnResult[1] = _1;
            }
        ...
        public static string Number(int startnumber, int endnumber)
        {
            string strNumber = rnd.Next(startnumber, endnumber).ToString();
            return strNumber;
        }
        /// <summary>
        /// AY 2017-11-28 10:01:19
        /// 版本1.0
        /// 获得用户 民族
        /// </summary>
        /// <returns>随机民族</returns>
