...
{
    public class AyAniBounceInLeft : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniBounceInLeft(FrameworkElement _element)
          : base("BounceInLeft", _element)
        { base.AnimateSpeed = 800; }

        public AyAniBounceInLeft(FrameworkElement _element, Action _completed)
