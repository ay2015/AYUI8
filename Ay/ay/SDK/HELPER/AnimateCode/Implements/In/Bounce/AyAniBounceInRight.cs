...
{
    public class AyAniBounceInRight : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniBounceInRight(FrameworkElement _element)
         : base("BounceInRight", _element)
        { base.AnimateSpeed = 800; }

        public AyAniBounceInRight(FrameworkElement _element, Action _completed)
            : base("BounceInRight", _element, _completed)
        {
            base.AnimateSpeed = 800;
        }
        #endregion
