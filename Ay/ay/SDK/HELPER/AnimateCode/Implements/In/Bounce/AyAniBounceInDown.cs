...
{
    public class AyAniBounceInDown : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniBounceInDown(FrameworkElement _element)
          : base("BounceInDown", _element)
        { base.AnimateSpeed = 800; }

        public AyAniBounceInDown(FrameworkElement _element, Action _completed)
            : base("BounceInDown", _element, _completed)
        {
            base.AnimateSpeed = 800;
        }
        #endregion
