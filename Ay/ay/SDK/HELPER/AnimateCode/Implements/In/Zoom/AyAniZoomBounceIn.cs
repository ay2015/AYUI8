...
{
    public class AyAniZoomBounceIn : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniZoomBounceIn(FrameworkElement _element)
           : base("AyAniZoomBounceIn", _element)
        { base.AnimateSpeed = 500; }

        public AyAniZoomBounceIn(FrameworkElement _element, Action _completed)
            : base("AyAniZoomBounceIn", _element, _completed)
        { base.AnimateSpeed = 500; }
