...
namespace ay.Animate
{
    ...
    public class AyAniZoomInUp : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniZoomInUp(FrameworkElement _element)
       : base("ZoomInUp", _element)
        { base.AnimateSpeed = 800; }

        public AyAniZoomInUp(FrameworkElement _element, Action _completed)
            : base("ZoomInUp", _element, _completed)
        { base.AnimateSpeed = 800; }
