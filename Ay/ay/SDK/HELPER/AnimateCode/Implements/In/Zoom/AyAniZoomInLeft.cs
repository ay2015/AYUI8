...
{
    public class AyAniZoomInLeft : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniZoomInLeft(FrameworkElement _element)
    : base("ZoomInLeft", _element)
        { base.AnimateSpeed = 800; }

        public AyAniZoomInLeft(FrameworkElement _element, Action _completed)
