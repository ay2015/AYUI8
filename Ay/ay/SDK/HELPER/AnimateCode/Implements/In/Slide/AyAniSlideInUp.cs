...
{
    public class AyAniSlideInUp : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniSlideInUp(FrameworkElement _element)
          : base("SlideInUp", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideInUp(FrameworkElement _element, Action _completed)
            : base("SlideInUp", _element, _completed)
        {
            base.AnimateSpeed = 300;
        }
        #endregion
