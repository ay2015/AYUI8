...
{
    public class AyAniSlideInDown : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniSlideInDown(FrameworkElement _element)
    : base("SlideInDown", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideInDown(FrameworkElement _element, Action _completed)
            : base("SlideInDown", _element, _completed)
        {
            base.AnimateSpeed = 300;
        }
        ...
        protected override void Init()
        {
            ...
            if (FromDistance == 0)
            {
                FromDistance = Element.RenderSize.Height * (-1.5);
            }
