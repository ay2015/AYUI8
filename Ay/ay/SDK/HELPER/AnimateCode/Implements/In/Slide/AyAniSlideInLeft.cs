...
{
    public class AyAniSlideInLeft : AyAnimateBaseIn
    {
        #region 构造函数
        public AyAniSlideInLeft(FrameworkElement _element)
         : base("SlideInLeft", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideInLeft(FrameworkElement _element, Action _completed)
            : base("SlideInLeft", _element, _completed)
        {
            base.AnimateSpeed = 300;
        }
        #endregion
