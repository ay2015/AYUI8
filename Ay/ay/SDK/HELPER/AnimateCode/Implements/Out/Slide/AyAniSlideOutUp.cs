...
{
    public class AyAniSlideOutUp : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniSlideOutUp(FrameworkElement _element)
           : base("SlideOutUp", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideOutUp(FrameworkElement _element, Action _completed)
