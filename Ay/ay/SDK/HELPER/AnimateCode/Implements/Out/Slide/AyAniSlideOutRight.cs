...
{
    public class AyAniSlideOutRight : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniSlideOutRight(FrameworkElement _element)
           : base("SlideOutRight", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideOutRight(FrameworkElement _element, Action _completed)
            : base("SlideOutRight", _element, _completed)
        {
            base.AnimateSpeed = 300;
        }
