...
{
    public class AyAniSlideOutDown : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniSlideOutDown(FrameworkElement _element)
         : base("SlideOutDown", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideOutDown(FrameworkElement _element, Action _completed)
            : base("SlideOutDown", _element, _completed)
        {
            base.AnimateSpeed = 300;
        }
        #endregion
