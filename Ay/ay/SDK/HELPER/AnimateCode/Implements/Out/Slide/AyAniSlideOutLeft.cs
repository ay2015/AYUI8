...
{
    public class AyAniSlideOutLeft : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniSlideOutLeft(FrameworkElement _element)
         : base("SlideOutLeft", _element)
        { base.AnimateSpeed = 300; }

        public AyAniSlideOutLeft(FrameworkElement _element, Action _completed)
            : base("SlideOutLeft", _element, _completed)
        {
            base.AnimateSpeed = 300;
        }
