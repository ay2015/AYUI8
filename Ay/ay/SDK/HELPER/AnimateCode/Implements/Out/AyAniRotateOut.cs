...
{
    public class AyAniRotateOut : AyAnimateBaseOut
    {
        #region 构造函数
        public AyAniRotateOut(FrameworkElement _element)
       : base("RotateOut", _element)
        { base.AnimateSpeed = 350; }

        public AyAniRotateOut(FrameworkElement _element, Action _completed)
