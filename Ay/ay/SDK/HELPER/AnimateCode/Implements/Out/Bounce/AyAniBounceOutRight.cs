...
{
    public class AyAniBounceOutRight : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniBounceOutRight(FrameworkElement _element)
          : base("BounceOutRight", _element)
        { base.AnimateSpeed = 900; }

        public AyAniBounceOutRight(FrameworkElement _element, Action _completed)
            : base("BounceOutRight", _element, _completed)
        {
            base.AnimateSpeed = 900;
        }
        #endregion
        ...
        private double threeValue = 2000;
        ...
        protected override void Init()
        {
            ...
            var k2_2 = new EasingDoubleKeyFrame(ThreeValue, TimeSpan.FromMilliseconds(AniTime(1)));
            ...
            var k3_0 = new EasingDoubleKeyFrame(1, TimeSpan.FromMilliseconds(AniTime(0.2)));
