...
{
    public class AyAniBounceOutLeft : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniBounceOutLeft(FrameworkElement _element)
    : base("BounceOutLeft", _element)
        { base.AnimateSpeed = 900; }

        public AyAniBounceOutLeft(FrameworkElement _element, Action _completed)
            : base("BounceOutLeft", _element, _completed)
        {
            base.AnimateSpeed = 900;
        }
        #endregion
