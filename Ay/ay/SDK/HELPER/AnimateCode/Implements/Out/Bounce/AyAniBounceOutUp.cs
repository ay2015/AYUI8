...
namespace ay.Animate
{
    ...
    public class AyAniBounceOutDown : AyAnimateBaseOut
    {
        #region 构造函数
        public AyAniBounceOutDown(FrameworkElement _element)
       : base("BounceOutDown", _element)
        { base.AnimateSpeed = 900; }

        public AyAniBounceOutDown(FrameworkElement _element, Action _completed)
            : base("BounceOutDown", _element, _completed)
        {
            base.AnimateSpeed = 900;
        }
