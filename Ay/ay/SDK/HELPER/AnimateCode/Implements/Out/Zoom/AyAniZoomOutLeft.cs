...
{
    public class AyAniZoomOutLeft : AyAnimateBaseOut
    {

        #region 构造函数
        public AyAniZoomOutLeft(FrameworkElement _element)
          : base("ZoomOutLeft", _element)
        { base.AnimateSpeed = 800; }

        public AyAniZoomOutLeft(FrameworkElement _element, Action _completed)
            : base("ZoomOutLeft", _element, _completed)
        { base.AnimateSpeed = 800; }
        #endregion
        #region 属性
