...
{
    public class AyAniZoomOutRight : AyAnimateBaseOut
    {

        #region 构造函数

        public AyAniZoomOutRight(FrameworkElement _element)
            : base("ZoomOutRight", _element)
        { base.AnimateSpeed = 800; }

        public AyAniZoomOutRight(FrameworkElement _element, Action _completed)
            : base("ZoomOutRight", _element, _completed)
        { base.AnimateSpeed = 800; }
        ...
        protected override void Init()
        {
            ...
            Element.RenderTransformOrigin = new Point(1, 0.5);
