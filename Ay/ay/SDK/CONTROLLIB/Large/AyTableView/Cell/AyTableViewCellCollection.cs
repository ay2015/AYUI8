...
{
  public class AyTableViewCellCollection : IList, ICollection, IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged
  {
    ...
    public AyTableViewCellCollection(object copyObject, int copyCount)
    {
      CopyCount = copyCount;
    ...
    private class TableCellCollectionEnumerator : IEnumerator
    {
      ...
      public TableCellCollectionEnumerator(AyTableViewCellCollection col)
      {
        _current = -1;
        _count = col.Count;
